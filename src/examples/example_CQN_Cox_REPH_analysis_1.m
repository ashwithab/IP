...
myCQNCoxREPH = CQNREPHCox(M, K, E, N, ENV, S, mu, phi, sched, P, NK, classMatch, refNodes, resetRules, nodeNames, classNames); 
max_iter = 1000;
delta_max = 0.01;
RT = 1;
RTrange = [0.01:0.01:0.99]'; 
verbose = 1;
[Q, U, R, X, ~, RT_CDF, ~] = CQN_Cox_REPH_analysis(myCQNCoxREPH, [], [], [], max_iter, delta_max, RT, RTrange, verbose);
