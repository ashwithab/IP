...
% Network with Class Switching  with Coxian service times in a Random
% Environment (RE), where the RE has Phase-type holding times. 
...
%constructor
function obj = CQNREPHCox(M, K, E, N, ENV, S, mu, phi, sched, P, NK, classMatch, refNodes, resetRules, nodeNames, classNames)
