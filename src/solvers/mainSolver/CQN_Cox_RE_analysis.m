function [Qavg, U, Ravg, Xavg, resEntry, RT_CDF,resEntry_CDF] = CQN_Cox_RE_analysis(myCQN, entry, entryGraphs, processors, max_iter, delta_max, RT, RTrange, verbose)
...
tic
y0 = [];
[Q, ymean_emb, piemb, ~, ~] = CQN_RE_fluid_ps(myCQN, max_iter, delta_max, y0, verbose);
