function [Qavg, U, Ravg, Xavg, resEntry, RT_CDF,resEntry_CDF] = CQN_Cox_REPH_analysis(myCQN, entry, entryGraphs, processors, max_iter, delta_max, RT, RTrange, verbose)
...
y0 = [];
[Q, ymean_emb, piemb, ~, ~] = CQN_REPH_fluid_ps(myCQN, max_iter, delta_max, y0, verbose);

%% RT CDF analysis 
if RT >= 1
    RT_CDF = CQN_RE_fluid_ps_RT(myCQN, max_iter, delta_max, ymean_emb, piemb, RTrange, verbose);
    if RT == 2
