function RT = CQN_RE_SRP_fluid_ps_RT(myCQN, max_iter, delta_max, ymean_emb, piemb, RTrange, verbose)
...
for e = nonNullE
    ...
    stageCQN = CQNCoxSRP (M, Mp, K, N, myCQN.S{e}, myCQN.Sp{e}, myCQN.W, Lambda, Pi, myCQN.sched, myCQN.P{e}, myCQN.NK, myCQN.classMatch, myCQN.refNodes, myCQN.nodeNames, myCQN.classNames);
    ...
    RTall{e} =  CQN_SRP_fluid_ps_RT(stageCQN, max_iter, delta_max, ymean_emb{end,e}, [], verbose);
end
